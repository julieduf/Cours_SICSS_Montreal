...
Titres1 <- read_html("https://guides.loc.gov/federalist-papers/text-1-10") |>
  html_nodes(css =".s-lib-box-title") |>
  html_text()

Auteurs1 <- read_html("https://guides.loc.gov/federalist-papers/text-1-10") |>
  html_nodes(css ="p+ p strong") |>
  html_text()

Textes1 <- read_html("https://guides.loc.gov/federalist-papers/text-1-10") |>
  html_nodes(css =".s-lib-box-title+ div .clearfix") |>
  html_text()

Titres2 <- read_html("https://guides.loc.gov/federalist-papers/text-11-20") |>
  html_nodes(css =".s-lg-box-wrapper-25493291 .s-lib-box-title , .s-lg-box-wrapper-25493290 .s-lib-box-title , .s-lg-box-wrapper-25493289 .s-lib-box-title , .s-lg-box-wrapper-25493288 .s-lib-box-title , .s-lg-box-wrapper-25493287 .s-lib-box-title , .s-lg-box-wrapper-25493286 .s-lib-box-title , .s-lg-box-wrapper-25493285 .s-lib-box-title , .s-lg-box-wrapper-25493284 .s-lib-box-title , .s-lg-box-wrapper-25493283 .s-lib-box-title , .s-lg-box-wrapper-25493282 .s-lib-box-title") |>
  html_text()

Auteurs2 <- read_html("https://guides.loc.gov/federalist-papers/text-11-20") |>
  html_nodes(css ="p:nth-child(3)") |>
  html_text()

Textes2 <- read_html("https://guides.loc.gov/federalist-papers/text-11-20") |>
  html_nodes(css =".s-lg-box-wrapper-25493291 .clearfix , .s-lg-box-wrapper-25493290 .clearfix , .s-lg-box-wrapper-25493289 .clearfix , .s-lg-box-wrapper-25493288 .clearfix , .s-lg-box-wrapper-25493287 .clearfix , .s-lg-box-wrapper-25493286 .clearfix , .s-lg-box-wrapper-25493285 .clearfix , .s-lg-box-wrapper-25493284 .clearfix , .s-lg-box-wrapper-25493283 .clearfix , .s-lg-box-wrapper-25493282 .clearfix") |>
  html_text()

results <- tibble(
  Titres = c(Titres1, Titres2),
  Auteurs = c(Auteurs1, Auteurs2),
  Textes = c(Textes1, Textes2)
)
...
doc24_idf_10 <- doc24_idf[1:10, ]   

graph_doc(doc12_idf_10)
graph_doc(doc24_idf_10)
...
filter(corpus_tidy_text_tfidf, id_num == 24) %>% {
  wordcloud(.$word, .$n, max.words = 20)
} 

filter(corpus_tidy_text_tfidf, id_num == 12 | id_num == 24) %>% {
  wordcloud(.$word, .$n, max.words = 20)
} 
...
```{r}
filter(corpus_tidy_text_tfidf, id_num == c(12, 24)) %>% {
