...
class(base_classe$nom)        # character
class(base_classe$sexe)       # character
...
class(base_classe$education)      # character
...
crsc96 <- read_csv("/Volumes/Transcend/SICSS2023/Cours_SICSS_Montreal/Semaine1_Formation_Intensive_R/Jour2_Manipulation/Données/cora-crsc1996-E-1996_F1.csv")
